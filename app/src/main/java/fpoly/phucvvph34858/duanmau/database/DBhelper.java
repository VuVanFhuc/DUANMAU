package fpoly.phucvvph34858.duanmau.database;
...
public class DBhelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String dbThanhVien = "CREATE TABLE THANHVIEN (matv integer primary key autoincrement, hoten text, namsinh text,stk text)";
        ...
        String dbSach = "CREATE TABLE SACH (masach integer primary key autoincrement, tensach text, giathue integer , maloai integer references  LOAISACH(maloai),sl text)";
        db.execSQL(dbSach);
        ...
        db.execSQL("INSERT INTO SACH VALUES(1,'Kẻ hủy diệt',2500,1,'10'),(2,'Titanic',1000,1,'20'),(3,'Lập trình android',2000,3,'30')");
        db.execSQL("INSERT INTO THUTHU VALUES('phuc','Nguyễn Văn Anh','admin','Admin','admin'),('thuthu01','Trần Văn Hùng','abc123','Thủ thư','abc123'),('thuthu02','Cao thi lieu','123abc','Thủ thư','123abc')");
        db.execSQL("INSERT INTO THANHVIEN VALUES(1,'Vu Van Phuc','2000','10'),(2,'nguyễn Văn B','2000','6')");
