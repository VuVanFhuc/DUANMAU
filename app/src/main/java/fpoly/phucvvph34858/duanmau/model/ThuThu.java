...
public class ThuThu {
    ...
    public
    ThuThu(String matt, String hoten, String matkhau, String loaitaikhoan, String nhaplaimatkhau) {
        this.matt = matt;
        this.hoten = hoten;
    ...
    public
    ThuThu(String matt, String hoten, String matkhau, String nhaplaimatkhau) {
        this.matt = matt;
        this.hoten = hoten;
        this.matkhau = matkhau;
        this.nhaplaimatkhau = nhaplaimatkhau;
